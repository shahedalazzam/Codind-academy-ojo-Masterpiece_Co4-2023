...
const AddUser = () => {
  ...
  const onSubmit = async (values) => {
    ...
    const response = await axios.post('http://localhost:8080/dashboard/adduser', data).catch((err) => {
      if (err && err.response) {
  ...
  const formik = useFormik({
    initialValues: { username: '', email: '', password: '', confirm_password: '', role: 'user', secret_key: '' },
    validateOnBlur: true,
    onSubmit,
              ...
              <div className="form-items">
                ...
                >
                  ...
                  <div className="col-md-12">
                    ...
                    }} value={''} className="form-control" type="email" name="email" placeholder="E-mail Address" required />
                  </div>
                  <div className="col-md-12">
                    <input onChange={(event) => {
                    }} value={''} className="form-control" type="password" name="password" placeholder="Password" required />
                  </div>
        ...
        <div className="form-body">
          <div className="row">
            <div className="form-holder">
              <div className="form-content">
                <div className="form-items">
                  <h3>Allowed Just For Super Admin</h3>
                  {/* <p>Fill in the data below.</p> */}
                  {/* <span className={error ? 'error' : ''}>{error ? error : ''}</span> */}
                  {/* <form
                    className="requires-validation"
