...
const validationSchema = yup.object({
    Name: yup.string().min(3, "enter product Name").required('productName is required'),
...
const AddItem = () => {
    ...
    const formik = useFormik({
        initialValues: { Name: '', Price: '', Color: '', Brand: '', Size: ''},
        validateOnBlur: true,
        onSubmit,
                            ...
                            <div className="form-items">
                                ...
                                <form
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        }} value={formik.values.Name} className="form-control" type="text" name="Name" placeholder="product Name" required />
                                        <span className={formik.touched.Name && formik.errors.Name ? "invalid-feedback" : "valid-feedback"}>{formik.touched.Name && formik.errors.Name ? formik.errors.Name : ""}</span>
                                    </div>
                                    <div className="col-md-12">
                                        <input onBlur={formik.handleBlur} onChange={(event) => {
                                            formik.handleChange(event);
